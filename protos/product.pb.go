...
func (x *ProductsInfo) GetProducts() []*ProductInfo {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_protos_product_proto_rawDesc = []byte{
	...
	0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x69, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64,
	...
	0x69, 0x63, 0x65, 0x22, 0x1a, 0x0a, 0x02, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	...
	0x40, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x73, 0x32, 0x8c, 0x02, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x35, 0x0a,
	...
	0x66, 0x6f, 0x30, 0x01, 0x12, 0x2f, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x32, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x0b, 0x2e, 0x70,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x0d, 0x55, 0x70, 0x64,
...
var file_protos_product_proto_goTypes = []interface{}{
	...
	(*Id)(nil),           // 2: product.Id
	(*Status)(nil),       // 3: product.Status
	(*ProductsInfo)(nil), // 4: product.ProductsInfo
}
var file_protos_product_proto_depIdxs = []int32{
	1, // 0: product.ProductsInfo.products:type_name -> product.ProductInfo
	0, // 1: product.Product.GetProducts:input_type -> product.Empty
	2, // 2: product.Product.GetProduct:input_type -> product.Id
	1, // 3: product.Product.CreateProduct:input_type -> product.ProductInfo
	1, // 4: product.Product.UpdateProduct:input_type -> product.ProductInfo
	2, // 5: product.Product.DeleteProduct:input_type -> product.Id
	1, // 6: product.Product.GetProducts:output_type -> product.ProductInfo
	1, // 7: product.Product.GetProduct:output_type -> product.ProductInfo
	2, // 8: product.Product.CreateProduct:output_type -> product.Id
	3, // 9: product.Product.UpdateProduct:output_type -> product.Status
	3, // 10: product.Product.DeleteProduct:output_type -> product.Status
